    ...
    public function index(): void
    {
        ...
        wwm_render_admin('students', [
            ...
            'error' => match ($_GET['error'] ?? '') {
                ...
                'filter_required' => 'Set at least one audience filter condition before launch.',
                'bulk_none' => 'No students match the selected filters.',
                'bulk_limit' => 'Audience too large — narrow the filter.',
                'bulk_inactive' => 'Selected process is not active.',
                'bulk_archived' => 'Selected process is archived.',
    ...
    public function show(int $id): void
    {
        ...
        wwm_render_admin('student-view', [
            ...
            'message' => match ($_GET['created'] ?? '') {
                ...
                'automation_cancelled' => 'Student removed from the process. No further emails or delays.',
                'login_mail' => 'Sign-in details email sent.',
                default => null,
            },
            'error' => match ($_GET['error'] ?? '') {
                'csrf' => 'Session expired. Please try again.',
                ...
                'automation_cancel' => 'Could not remove from process: run not found or not active.',
                'login_mail' => 'Could not send email. Check SMTP and cabinet.log.',
                default => null,
            },
        ]);
    }
